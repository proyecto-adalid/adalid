...
/**
 * WebAppMaps genera los mapas mentales de su aplicación utilizando la plataforma webapp-maps.
 * <p>
 * La plataforma webapp-maps aún se encuentra en versión beta. Una beta representa la primera versión completa de un programa informático, que es
 ...
 */
@RunnableClass
public class WebAppMaps extends adalid.util.Utility {
     ...
     */
    private static final String PLATFORM = adalid.util.Platform.WEBAPP_MAPS;
