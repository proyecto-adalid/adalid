 ...
 */
@MasterProject(alias = Maestro112.ALIAS) //, helpFile = Maestro112.ALIAS, helpFileAutoName = HelpFileAutoName.ENTITY, helpFileAutoType = "xhtml")
public class Maestro112 extends Maestro {
    ...
    public static void main(String[] args) throws Exception {
        Maestro112.class.getDeclaredConstructor().newInstance().build(PLATAFORMA_MAVEN_ORACLE_WILDFLY);
    }
