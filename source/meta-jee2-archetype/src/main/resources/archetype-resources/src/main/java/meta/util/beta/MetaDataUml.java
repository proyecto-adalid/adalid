 ...
 * <p>
 * Los diagramas de actividad se generan para operaciones de insert, update y de negocio; los diagramas de clases se generan para módulos y entidades;
...
public class MetaDataUml extends adalid.util.Utility {
     ...
     */
    private static final String PLATFORM = "meta-data-uml";
