 ...
 * generación del diagrama utilizando PlantUML. Los archivos se almacenan en el subdirectorio /source/development/resources/documents/uml/class del
 * proyecto generado.
 * <p>
 * La plataforma meta-data-uml-class aún se encuentra en versión beta. Una beta representa la primera versión completa de un programa informático, que
