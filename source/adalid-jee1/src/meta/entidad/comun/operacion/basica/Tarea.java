...
@EntityCodeGen(sql = Kleenean.FALSE)
public class Tarea extends AbstractPersistentEntity {
...
/**/
    ...
    public Tarea(Artifact declaringArtifact, Field declaringField) {
...
//      setDefaultShortLabel("tarea");
        setDefaultCollectionLabel("tareas");
//      setDefaultCollectionShortLabel("tareas");
    }
