...
public class TipoClaseRecurso extends AbstractPersistentEnumerationEntity {
    ...
    @PrimaryKey
    public IntegerProperty numeroTipoClaseRecurso;

    @BusinessKey
    public StringProperty codigoTipoClaseRecurso;
    ...
    protected void settleAttributes() {
        ...
        setDefaultLabel("tipo de clase de recurso");
        setDefaultShortLabel("tipo");
        setDefaultCollectionLabel("Tipos de Clase de Recurso");
