 ...
 */
public class PaqueteRegistroControlRutinas extends PaqueteRegistroBase {

    @Override
    protected void settleAttributes() {
        super.settleAttributes();
        setAlias("RecursosControlRutinas");
        // <editor-fold defaultstate="collapsed" desc="localization of PaqueteRegistroControlRutinas's attributes">
        setLocalizedLabel(ENGLISH, "Routine Control Resources Registration");
        setLocalizedLabel(SPANISH, "Registro de Recursos de Control de Rutinas");
        setLocalizedDescription(ENGLISH, "Routine Control Resources Registration");
        setLocalizedDescription(SPANISH, "Registro de Recursos de Control de Rutinas");
