...
//      setSchema(ProyectoBase.getEsquemaEntidadesComunes());
        // <editor-fold defaultstate="collapsed" desc="localization of TipoDominio's attributes">
        setLocalizedLabel(ENGLISH, "domain type");
        setLocalizedLabel(SPANISH, "tipo de dominio");
//      setLocalizedShortLabel(ENGLISH, "type");
//      setLocalizedShortLabel(SPANISH, "tipo");
        setLocalizedCollectionLabel(ENGLISH, "Domain Types");
        setLocalizedCollectionLabel(SPANISH, "Tipos de Dominio");
...
//      setLocalizedCollectionShortLabel(SPANISH, "Tipos");
    ...
    protected void settleProperties() {
        ...
        // <editor-fold defaultstate="collapsed" desc="localization of TipoDominio's properties">
        numero.setLocalizedLabel(ENGLISH, "domain type number");
        numero.setLocalizedLabel(SPANISH, "número del tipo de dominio");
        numero.setLocalizedShortLabel(ENGLISH, "number");
        numero.setLocalizedShortLabel(SPANISH, "número");
        /**/
        codigo.setLocalizedLabel(ENGLISH, "domain type code");
        codigo.setLocalizedLabel(SPANISH, "código del tipo de dominio");
    ...
    protected void settleInstances() {
        ...
        // <editor-fold defaultstate="collapsed" desc="localization of TipoDominio's instances">
