...
public class FA {
    ...
    public static final String MISSING_VALUE = QUESTION_CIRCLE_O;

    public static final String NULL_VALUE = QUESTION_CIRCLE_O;

    public static final String UNNECESSARY_VALUE = TIMES;
