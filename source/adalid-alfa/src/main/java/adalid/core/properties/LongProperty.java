 ...
 */
public class LongProperty extends LongData implements NumericProperty {
    ...
    protected List<Class<? extends Annotation>> getValidFieldAnnotations() {
        ...
        valid.add(SegmentProperty.class); // since 20210218
        valid.add(SequenceProperty.class);
        valid.add(UniqueKey.class);
        valid.add(VersionProperty.class);
        return valid;
    }
