 ...
 */
public class CharacterRowsAggregateX extends AbstractRowsAggregateX implements CharacterExpression {

    CharacterRowsAggregateX(RowsAggregateOp operator, Object measure) {
        super(operator, measure);
    }

    CharacterRowsAggregateX(RowsAggregateOp operator, Object measure, Segment filter) {
        super(operator, measure, filter);
    }

    CharacterRowsAggregateX(RowsAggregateOp operator, Object measure, Entity dimension) {
        super(operator, measure, dimension);
    }

    CharacterRowsAggregateX(RowsAggregateOp operator, Object measure, Segment filter, Entity dimension) {
