...
public class TemporalRowsAggregateX extends AbstractRowsAggregateX implements TemporalExpression {
    ...
    TemporalRowsAggregateX(RowsAggregateOp operator, Object measure) {
        super(operator, measure);
    }

    TemporalRowsAggregateX(RowsAggregateOp operator, Object measure, Segment filter) {
        super(operator, measure, filter);
    }

    TemporalRowsAggregateX(RowsAggregateOp operator, Object measure, Entity dimension) {
        super(operator, measure, dimension);
    }

    TemporalRowsAggregateX(RowsAggregateOp operator, Object measure, Segment filter, Entity dimension) {
