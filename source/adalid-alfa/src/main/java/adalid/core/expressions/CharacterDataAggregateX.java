 ...
 */
public class CharacterDataAggregateX extends AbstractDataAggregateX implements CharacterExpression {

    CharacterDataAggregateX(DataAggregateOp operator, Object... operands) {
