 ...
 */
public class NumericOrderedPairX extends AbstractOrderedPairX implements NumericExpression {

    NumericOrderedPairX(Object x, OrderedPairOp operator, Object y) {
        super(x, operator, y);
    }
