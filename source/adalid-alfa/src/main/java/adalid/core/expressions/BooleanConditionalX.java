 ...
 */
public class BooleanConditionalX extends AbstractConditionalX implements Check, State {

    BooleanConditionalX(BooleanExpression booleanExpression, Object value) {
        super(booleanExpression, value);
    }

    public BooleanOtherwiseX otherwise(Boolean value) {
        return XB.Boolean.Conditional.otherwise(this, value);
    }

    public BooleanOtherwiseX otherwise(SpecialBooleanValue value) {
        return XB.Boolean.Conditional.otherwise(this, value);
    }

    public BooleanOtherwiseX otherwise(BooleanExpression value) {
        return XB.Boolean.Conditional.otherwise(this, value);
    }
