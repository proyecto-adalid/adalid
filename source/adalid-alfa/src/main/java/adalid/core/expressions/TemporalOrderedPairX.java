 ...
 */
public class TemporalOrderedPairX extends AbstractOrderedPairX implements TemporalExpression {

    TemporalOrderedPairX(Object x, OrderedPairOp operator, Object y) {
        super(x, operator, y);
    }
