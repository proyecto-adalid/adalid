...
public class TemporalConditionalX extends AbstractConditionalX implements TemporalExpression {
    ...
    TemporalConditionalX(BooleanExpression booleanExpression, Object value) {
        super(booleanExpression, value);
    }

    public TemporalOtherwiseX otherwise(java.util.Date value) {
        return XB.Temporal.Conditional.otherwise(this, value);
    }
