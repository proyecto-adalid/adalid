 ...
 */
public class BooleanOrderedPairX extends AbstractOrderedPairX implements Check, State {

    BooleanOrderedPairX(BooleanExpression x, OrderedPairOp operator, BooleanExpression y) {
        super(x, operator, y);
    }
