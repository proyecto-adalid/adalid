 ...
 */
public class NumericConditionalX extends AbstractConditionalX implements NumericExpression {

    NumericConditionalX(BooleanExpression booleanExpression, Object value) {
        super(booleanExpression, value);
    }

    public NumericOtherwiseX otherwise(Number value) {
        return XB.Numeric.Conditional.otherwise(this, value);
    }

    public NumericOtherwiseX otherwise(SpecialNumericValue value) {
        return XB.Numeric.Conditional.otherwise(this, value);
    }

    public NumericOtherwiseX otherwise(NumericExpression value) {
        return XB.Numeric.Conditional.otherwise(this, value);
    }
