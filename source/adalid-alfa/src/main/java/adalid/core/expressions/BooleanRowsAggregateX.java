 ...
 */
public class BooleanRowsAggregateX extends AbstractRowsAggregateX implements Check, State {

    BooleanRowsAggregateX(RowsAggregateOp operator, Object measure) {
        super(operator, measure);
    }

    BooleanRowsAggregateX(RowsAggregateOp operator, Object measure, Segment filter) {
        super(operator, measure, filter);
    }

    BooleanRowsAggregateX(RowsAggregateOp operator, Object measure, Entity dimension) {
        super(operator, measure, dimension);
    }

    BooleanRowsAggregateX(RowsAggregateOp operator, Object measure, Segment filter, Entity dimension) {
