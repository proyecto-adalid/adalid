 ...
 */
public class CharacterOrderedPairX extends AbstractOrderedPairX implements CharacterExpression {

    CharacterOrderedPairX(Object x, OrderedPairOp operator, Object y) {
        super(x, operator, y);
    }
