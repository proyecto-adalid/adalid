 ...
 */
public class CharacterConditionalX extends AbstractConditionalX implements CharacterExpression {

    CharacterConditionalX(BooleanExpression booleanExpression, Object value) {
        super(booleanExpression, value);
    }

    public CharacterOtherwiseX otherwise(String value) {
        return XB.Character.Conditional.otherwise(this, value);
    }

    public CharacterOtherwiseX otherwise(SpecialCharacterValue value) {
        return XB.Character.Conditional.otherwise(this, value);
    }

    public CharacterOtherwiseX otherwise(Expression value) {
        return XB.Character.Conditional.otherwise(this, toCharacterExpression(value));
    }
