...
public class BooleanComparisonX extends AbstractComparisonX implements Check, State {
    ...
    BooleanComparisonX(Object x, ComparisonOp operator) {
        super(x, operator);
    }

    BooleanComparisonX(Object x, ComparisonOp operator, Object y) {
        super(x, operator, y);
    }

    BooleanComparisonX(Object x, ComparisonOp operator, Object y, Object z) {
        super(x, operator, y, z);
    }
