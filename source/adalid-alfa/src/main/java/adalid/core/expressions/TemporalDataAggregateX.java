 ...
 */
public class TemporalDataAggregateX extends AbstractDataAggregateX implements TemporalExpression {

    TemporalDataAggregateX(DataAggregateOp operator, Object... operands) {
