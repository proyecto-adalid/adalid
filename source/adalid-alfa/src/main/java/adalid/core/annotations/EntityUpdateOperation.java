...
public @interface EntityUpdateOperation {
    ...
    /**
     * enabled indica si las vistas (páginas) de registro deben permitir, o no, modificar instancias de la entidad, es decir, actualizar filas de la
     ...
     * permitir modificar; en caso contrario, seleccione FALSE. Alternativamente, omita el elemento o seleccione UNSPECIFIED para utilizar el valor
    ...
    /**
     * confirmation indica si las vistas (páginas) de registro deben solicitar, o no, confirmación al modificar instancias de la entidad, es decir,
     * actualizar filas de la tabla de la base de datos correspondiente a la entidad. Su valor es uno de los elementos de la enumeración Kleenean.
