...
public @interface EntitySelectOperation {
     ...
     * NO_ACTION suele utilizarse si la vista incluye un snippet para suministrar criterios de búsqueda para la consulta como, por ejemplo, el snippet
     * genérico Constants.QUICK_FILTER_SNIPPET). Alternativamente, omita el elemento o seleccione DEFAULT para utilizar el valor predeterminado del
     * atributo. Si la entidad representa una enumeración, entonces el valor predeterminado del atributo es EXECUTE; de lo contrario, si la vista
     * incluye un snippet para suministrar criterios de búsqueda (vea el elemento quickFilter de la anotación EntityTableView), el valor
     * predeterminado del atributo es NO_ACTION; en los demás casos, el valor predeterminado del atributo es PROMPT.
     *
     * @return onload
     */
