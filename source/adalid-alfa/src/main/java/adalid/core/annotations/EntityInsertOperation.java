...
public @interface EntityInsertOperation {
    ...
    /**
     * enabled indica si las vistas (páginas) de registro deben permitir, o no, agregar nuevas instancias de la entidad, es decir, insertar nuevas
     * filas de la tabla de la base de datos correspondiente a la entidad. Su valor es uno de los elementos de la enumeración Kleenean. Seleccione
     * TRUE para permitir agregar; en caso contrario, seleccione FALSE. Alternativamente, omita el elemento o seleccione UNSPECIFIED para utilizar el
    ...
    /**
     * confirmation indica si las vistas (páginas) de registro deben solicitar, o no, confirmación al agregar nuevas instancias de la entidad, es
     * decir, insertar nuevas filas de la tabla de la base de datos correspondiente a la entidad. Su valor es uno de los elementos de la enumeración
     * Kleenean. Seleccione TRUE para solicitar confirmación; en caso contrario, seleccione FALSE. Alternativamente, omita el elemento o seleccione
     * UNSPECIFIED para utilizar el valor predeterminado del atributo. El valor predeterminado del atributo es el establecido con el método
