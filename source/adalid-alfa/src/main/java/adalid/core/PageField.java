...
public class PageField extends DisplayField {
    ...
    public PageField(Display display, EntityCollection collection) {
    ...
    public PageField(Display display, QueryTable queryTable, Property property, DisplayField parentField) {
