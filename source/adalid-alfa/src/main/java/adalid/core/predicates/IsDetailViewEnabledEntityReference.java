...
//                  return false;
//              }
                return (reference.isOneToOne() && reference.isOneToOneDetailView())
                    || (reference.isManyToOne() && MasterDetailView.TABLE_AND_DETAIL.equals(reference.getMasterDetailView()));
            }
        }
        return false;
    }
